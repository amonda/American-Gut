...
Meta$Sex[Meta$Sex=="Unknown"] <- "Unknown"
Meta$Sex[Meta$Sex=="unspecified"] <- "Unknown"
Meta$Sex
...
Meta$Race[Meta$Race=="Unspecified"] <- "Unknown"
Meta$Race[Meta$Race=="Unknown"] <- "Unknown"
Meta$Race
...
Meta$Education[Meta$Education=="Uknown"] <- "Unknown"
Meta$Education[Meta$Education=="Unspecified"] <- "Unknown"
...
Meta$Antibiotics[Meta$Antibiotics=="Uknown"] <- "Unknown"
Meta$Antibiotics[Meta$Antibiotics=="Unspecified"] <- "Unknown"

#Probiotics
Meta$Probiotics<- Meta$"PROBIOTIC_FREQUENCY"
Meta$Probiotics[Meta$Probiotics=="Unknown"] <- "Unknown"
Meta$Probiotics[Meta$Probiotics=="Unspecified"] <- "Unknown"

#ExFreq 
Meta$ExFreq <-Meta$"EXERCISE_FREQUENCY"
Meta$ExFreq[Meta$ExFreq=="Unknown"] <- "Unknown"
Meta$ExFreq[Meta$ExFreq=="Unspecified"] <- "Unknown"

#ExLoc 
Meta$ExLoc<- Meta$"EXERCISE_LOCATION"
Meta$ExLoc[Meta$ExLoc=="Depends on the season"] <- "Both"
Meta$ExLoc[Meta$ExLoc=="Unknown"] <- "Unknown"
Meta$ExLoc[Meta$ExLoc=="Unspecified"] <- "Unknown"

#PoolFreq 
Meta$PoolFreq<- Meta$"POOL_FREQUENCY"
Meta$PoolFreq[Meta$PoolFreq=="Unknown"] <- "Unknown"
Meta$PoolFreq[Meta$PoolFreq=="Unspecified"] <- "Unknown"

#Diet
Meta$Diet<- Meta$"DIET_TYPE"
Meta$Diet[Meta$Diet=="Unknown"] <- "Unknown"
Meta$Diet[Meta$Diet=="Unspecified"] <- "Unknown"
...
Meta$Healthy[Meta$Healthy=="true"] <- "Healthy"
Meta$Healthy[Meta$Healthy=="false"] <- "Chronic Illness"
Meta$Healthy[Meta$Healthy=="Uknown"] <- "Unknown"
Meta$Healthy[Meta$Healthy=="Unspecified"] <- "Unknown"

```

Look for implausible values that need to be removed from the analysis, and observe distributions. 
Age, BMI, Age by physical activity
```{r}
...
list2Vars <- c(Age_Cat="AGE_CAT", Sex="SEX", Race="RACE", BMI_Cat="BMI_CAT", 
...
#Chronic Illness
#set levels to integers, then use unit command in tidr, then recode levels as 0 and >=1
...
MetaIdeal$Chronic <- unite(MetaIdeal, "CANCER", "KIDNEY_DISEASE", "DIABETES", "LUNG_DISEASE", "ASD", "IBS", "IBD", "LIVER_DISEASE",  "CARDIOVASCULAR_DISEASE", "AUTOIMMUNE", "ALZHEIMERS", "SEASONAL_ALLERGIES", "THYROID", "SKIN_CONDITION")
...
Now that the data is reorganized and cleaned it is time to run an initial analysis to see if recoding and grouping worked. 
```{r}
