...
Meta <- read_delim("~/Desktop/ag_1k_fecal.txt", 
    "\t", escape_double = FALSE, col_types = cols(AGE_YEARS = col_number(), 
        ...
        VIOSCREEN_SFA100 = col_number(), 
        VIOSCREEN_SFA170 = col_number(), 
...
#Age
#Should probably remove kids
Meta$Age<-Meta$"AGE_YEARS"

#BMI- coded as wanted check implausible values after recoding
...
plot_heatmap(ps, method = NULL, distance = NULL,
  sample.label = ExFreq, taxa.label = "Rank 5", trans = log_trans(4),
