...
#Antibiotics 
Antibiotics<-"ANTIBIOTIC_HISTORY"
Meta$Antibiotics[Meta$Antibiotics=="Week"] <- "Week"
Meta$Antibiotics[Meta$Antibiotics=="Month"] <- "Month"
Meta$Antibiotics[Meta$Antibiotics=="6 months"] <- "6 Months"
Meta$Antibiotics[Meta$Antibiotics=="Year"] <- "Year"
Meta$Antibiotics[Meta$Antibiotics=="Uknown"] <- "More than 1 year"
Meta$Antibiotics[Meta$Antibiotics=="Uknown"] <- "Unknown"
Meta$Antibiotics[Meta$Antibiotics=="Unspecified"] <- "Unknown"

#Probiotics
Probiotics<- "PROBIOTIC_FREQUENCY"

#ExFreq 
ExFreq <-c(ExFreq= "EXERCISE_FREQUENCY")

#ExLoc 
ExLoc<- "EXERCISE_LOCATION"

#PoolFreq 
PoolFreq<- "POOL_FREQUENCY"
