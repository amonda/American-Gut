...
listVars <- c(Age="AGE_YEARS", Sex="SEX", Race="RACE", BMI="BMI_CAT", 
...
list2Vars <- c(Age="AGE_YEARS", Sex="SEX", Race="RACE", BMI="BMI_CAT", 
...
catVars <- c(Sex="SEX", Race="RACE", BMI="BMI_CAT", 
Education="LEVEL_OF_EDUCATION", Antibiotics="ANTIBIOTIC_HISTORY", Probiotics="PROBIOTIC_FREQUENCY",ExFreq= "EXERCISE_FREQUENCY", ExLoc="EXERCISE_LOCATION", PoolFreq="POOL_FREQUENCY", Diet="DIET_TYPE")
...
CreateTableOne(vars=list2Vars, strata=ExFreq, data=MetaIdeal, factorVars=catVars, includeNA = FALSE,
